 ...
 * </p>
 * <ul>
 *   <li>{@link bank.impl.ClientImpl#getHas <em>Has</em>}</li>
 *   <li>{@link bank.impl.ClientImpl#getOwns <em>Owns</em>}</li>
...
public class ClientImpl extends MinimalEObjectImpl.Container implements Client {
	 ...
	 * @ordered
	 */
	protected EList<Portfolio> owns;
	 ...
	 */
	@Override
	public EList<Account> getHas() {
		if (has == null) {
			has = new EObjectResolvingEList<Account>(Account.class, this, BankPackage.CLIENT__HAS);
		}
		return has;
	}
	 ...
	 */
	@Override
	public EList<Portfolio> getOwns() {
		if (owns == null) {
			owns = new EObjectResolvingEList<Portfolio>(Portfolio.class, this, BankPackage.CLIENT__OWNS);
		}
		return owns;
	}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
		case BankPackage.CLIENT__HAS:
			return getHas();
		case BankPackage.CLIENT__OWNS:
			return getOwns();
	...
	public void eSet(int featureID, Object newValue) {
		...
		case BankPackage.CLIENT__HAS:
			getHas().clear();
			getHas().addAll((Collection<? extends Account>) newValue);
			return;
		case BankPackage.CLIENT__OWNS:
			getOwns().clear();
			getOwns().addAll((Collection<? extends Portfolio>) newValue);
			return;
		case BankPackage.CLIENT__NAME:
